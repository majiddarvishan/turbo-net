...
// Structure to hold callbacks and expiration data for a pending request.
...
private:
    ...
    // Schedules the common timeout timer based on pending request deadlines.
    ...
    // Single timeout timer (one per connection) to check for expired requests.
